...
@section('title','Cadastrar Alcalinidade')
@section('path')
<a href="{{ route("piscicultura.listar") }}">Pisciculturas</a> > <a href="{{ route("piscicultura.informar", ["id" => $piscicultura->id]) }}"> {{$piscicultura->nome}} </a> > <a href="{{ route("tanque.listar", ["id" => $piscicultura->id]) }}"> Tanques </a> > Alcalinidade
@stop
@section('content')
<div class="container">
      ...
      <div class="col-md-8">
          <div class="card">
              <div class="card-header">
                  Cadastrar Alcalinidade
              </div>
              <div class="card-body">
                <form action="/adicionarAlcalinidade" method="post">
                  {{ csrf_field() }}
