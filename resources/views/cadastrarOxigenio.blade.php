...
@section('title','Cadastrar Oxigênio')
@section('path')
<a href="{{ route("piscicultura.listar") }}">Pisciculturas</a> > <a href="{{ route("piscicultura.informar", ["id" => $piscicultura->id]) }}"> {{$piscicultura->nome}} </a> > <a href="{{ route("tanque.listar", ["id" => $piscicultura->id]) }}"> Tanques </a> > Oxigênio	
@stop
@section('content')
<div class="container">
      ...
      <div class="col-md-8">
          <div class="card">
              <div class="card-header">
                  Cadastrar Nível de Oxigênio
              </div>
              <div class="card-body">
                <form action="/adicionarOxigenio" method="post">
                  {{ csrf_field() }}
