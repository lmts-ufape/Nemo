              ...
              <div class="card-body">
                  <form action="/adicionarQualidadeAgua" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <label>PH</label>
                      <input id="ph" class="form-control" type="number" name="ph" min="0" max="14" style="display: none"/><br/>
                      <input type="checkbox" name="temperaturaBox" id="temperaturaBox" onchange="teste(this)" />
                      <label>Temperatura</label>
                      <input id="temperatura" class="form-control" type="number" name="temperatura"  value="{{old('temperatura')}}" style="display: none"/><br/>
                      <input type="checkbox" name="oxigenioBox" id="oxigenioBox" onchange="teste(this)" />
                      <label>Nível de Oxigênio</label>
                      <input id="oxigenio" class="form-control" type="number" name="oxigenio"  value="{{old('oxigenio')}}" style="display: none"/><br/>
                      <input type="checkbox" name="amoniaBox" id="amoniaBox" onchange="teste(this)" />
                      <label>Amônia</label>
                      <input id="amonia" class="form-control" type="number" name="amonia"  value="{{old('amonia')}}" style="display: none"/><br/>
                      <input type="checkbox" name="nitrato" id="nitratoBox" onchange="teste(this)" />
                      <label>Nitrato</label>
                      <input id="nitrato" class="form-control" type="number" name="nitrato"  value="{{old('ph')}}" style="display: none"/><br/>
                      <input type="checkbox" name="nitritoBox" id="nitritoBox" onchange="teste(this)" />
                      <label>Nitrito</label>
                      <input id="nitrito" class="form-control" type="number" name="nitrito"  value="{{old('ph')}}" style="display: none"/><br/>
                      <input type="checkbox" name="durezaBox" id="durezaBox" onchange="teste(this)" />
                      <label>Dureza</label>
                      <input id="dureza" class="form-control" type="number" name="dureza"  value="{{old('ph')}}" style="display: none"/><br/>
                      <input type="checkbox" name="alcalinidadeBox" id="alcalinidadeBox" onchange="teste(this)" />
                      <label>Alcalinidade</label>
                      <input id="alcalinidade" class="form-control" type="number" name="alcalinidade"  value="{{old('ph')}}" style="display: none"/><br/>
